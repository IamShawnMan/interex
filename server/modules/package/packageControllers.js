...
exports.getOrdersByPackage = catchAsync(async (req, res, next) => {
	...
	let ordersbyPackage = await Order.findAndCountAll(queryBuilder.queryOptions);
...
exports.downloadWord = catchAsync(async (req, res, next) => {
	...
	let ordersArr = [];
	for (let i = 0; i < allNewOrdersbyPackage.length; i + 2) {
							...
							children: [
										...
										new TextRun({
											text: `${
												new Intl.DateTimeFormat("RU-RU", {
													dateStyle: "short",
												}).format(orderArr[0].createdAt) || null
											}`,
											bold: true,
										}),
									],
								...
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[0].storeOwner?.storeName || null}`,
											bold: true,
										}),
									],
								}),
								...
								new Paragraph({
									...
									children: [
										...
										new TextRun({
											text: `${
												orderArr[0].region?.name.substr(
													0,
													orderArr[0].region?.name.indexOf(" ")
												) || null
											} v,  ${orderArr[0].district?.name || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[0].recipient || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[0].recipientPhoneNumber || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun({
											text: `${
												orderArr[0].totalPrice.toLocaleString("RU-RU") || null
											} so\`m`,
											bold: true,
										}),
									],
								...
								new Paragraph({
									alignment: AlignmentType.CENTER,
									children: [
										new TextRun("Mutaxassis: - "),
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[0].storeOwner?.firstName || null} - ${
												orderArr[0].storeOwner?.phoneNumber || null
											}`,
											bold: true,
										}),
									],
										...
										new TextRun({
											text: `${
												orderArr[0].note.slice(
													orderArr[0].note.indexOf("FIRMA") + 7
												) || null
											}`,
											bold: true,
										}),
							...
							children: [
								...
								new Paragraph({
									...
									children: [
										...
										new TextRun({
											text: `${
												orderArr[1].region?.name.substr(
													0,
													orderArr[1].region?.name.indexOf(" ")
												) || null
											} v,  ${orderArr[1].district?.name || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[1].recipient || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[1].recipientPhoneNumber || null}`,
											bold: true,
										}),
									],
								}),
								new Paragraph({
									...
									children: [
										...
										new TextRun({
											text: `${
												orderArr[1].totalPrice?.toLocaleString("RU-RU") || null
											} so\`m`,
											bold: true,
										}),
									],
								...
								new Paragraph({
									...
									children: [
										...
										new TextRun("   "),
										new TextRun({
											text: `${orderArr[1].storeOwner?.firstName || null} -- ${
												orderArr[1].storeOwner?.phoneNumber || null
											}`,
											bold: true,
										}),
									],
